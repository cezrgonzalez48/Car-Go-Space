<html>
   ...
   <body style="background-color: white;">
	  ...
	  <ul class="navbar-nav">
		...
		<!--<form action="maint.php"> -->	
		<form action = "login.php" method = "post">
			
			<br><br>
			<p><center><table>
  <tr>
    <th><center><strong style="font-size:30px">Sign in</strong>
    </center></th>
  </tr>
  ...
  <tr>
	...
	<?php if(isset($_GET['error'])) {?>
		<p class="error" style="font-size:20px; color:red"> <?php echo $_GET['error']; ?> </p>
	<?php } ?>
	<input size = 150 type="text" placeholder="Enter Email" name="email" required style="background-color: f4f5f6; border-color: darkgray">
	</center></td>
  </tr>
				
  <tr>
    <td><center>
    <input type="password" placeholder="Enter Password" name="password" size=10px required style="background-color: f4f5f6; border-color: darkgray">
	</center></td>
    ...
    <center><button type="submit" style="background-color: black; border-color: black; color: white">Login</button>
      <br>
	  <br>
